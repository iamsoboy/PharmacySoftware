...
@section('head')
    <title>Pharmacy - Drug {{ucfirst($title)}}</title>
@endsection
                    ...
                    <div class="nk-block nk-block-lg">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <form action="{{route('pharmacy.drugAllergy.store')}}" method="post" class="gy-3">
                            ...
                            <div class="card-inner">
                                <table class="table table-ulogs">
                                    ...
                                    @forelse($allergies as $allergy)
                                        <tr>
                                            <td class="tb-col-os">{{$allergy->name}}</td>
                                            <td class="tb-col-ip"><span class="sub-text">{{$allergy->description}}</span></td>
                                            <td class="tb-col-action">
                                                <div class="justify-center">
                                                    <div class="tb-odr-btns d-none d-md-inline mr-2">
                                                        <a href="{{route('pharmacy.drugAllergy.edit', $allergy->id)}}" class="btn btn-sm btn-primary">Edit</a>
                                                    </div>
                                                    <div class="tb-odr-btns d-none d-md-inline">
                                                        <form action="{{route('pharmacy.drugAllergy.destroy', $allergy->id)}}" method="post">
                                                            @method('delete')
                                                            @csrf
