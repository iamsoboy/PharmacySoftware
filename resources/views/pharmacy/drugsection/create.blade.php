                    ...
                    <div class="nk-block nk-block-lg">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <form action="{{route('pharmacy.drugDetail.store')}}" method="post" class="gy-3">
                            ...
                            <div class="card-inner">
                                <table class="table table-ulogs">
                                    ...
                                    @forelse($sections as $section)
                                        <tr>
                                            <td class="tb-col-os">{{$section->name}}</td>
                                            <td class="tb-col-ip"><span class="sub-text">{{$section->description}}</span></td>
                                            <td class="tb-col-action">
                                                <div class="justify-center">
                                                    <div class="tb-odr-btns d-none d-md-inline mr-2">
                                                        <a href="{{route('pharmacy.drugDetail.edit', $section->id)}}" class="btn btn-sm btn-primary">Edit</a>
                                                    </div>
                                                    <div class="tb-odr-btns d-none d-md-inline">
                                                        <form action="{{route('pharmacy.drugDetail.destroy', $section->id)}}" method="post">
                                                            @method('delete')
                                                            @csrf
