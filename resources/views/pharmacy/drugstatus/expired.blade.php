...
@section('head')
    <title>Pharmacy - Expired Drug(s) List</title>
@endsection
                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title">Expired Drug List</h4>
                            ...
                            <div class="card-inner">
                                <table class="datatable-init nk-tb-list nk-tb-ulist table">
                                    ...
                                    @forelse($expired as $drug)
                                        <tr>
                                            <td class="nk-tb-col text-danger-dim">
                                                <div class="user-info">
                                            ...
                                            <td>{{ $drug->category }}</td>
                                            <td class="text-danger">{{ \Carbon\Carbon::parse($drug->expiry_date)->format('F j, Y') }}</td>
                                            <td>{{ $drug->dosage }}</td>
