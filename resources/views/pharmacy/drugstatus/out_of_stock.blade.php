...
@section('head')
    <title>Pharmacy - Out of Stock Drug(s) List</title>
@endsection
                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title">Out of Stock Drug List</h4>
                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist table">
                                    ...
                                    @forelse($outOfStock as $drug)
                                        <tr>
                                            ...
                                            <td>{{ $drug->category }}</td>
                                            <td>{{ \Carbon\Carbon::parse($drug->expiry_date)->format('F j, Y') }}</td>
                                            <td>{{ $drug->dosage }}</td>
                                            <td class="text-azure">{{ $drug->store_balance }}</td>
